...
declare_id!("9Vzs2Txxni3xYNUqWEiCieg8f4dCjafrmDLgNwhFn679");
...
pub mod todo_list {
    ...
    pub fn new_list(
        ...
        // Create new account to acommodate our "todo list"
...
*/
#[derive(Accounts)]
#[instruction(name: String, capacity: u16, bump: u8)]
